    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-4 cat-form">
                ...
                @if(count((is_countable($data)?$admin:[]))>0)
                    <form method="post" action="{{ url('addsettings') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>About Us - {{ url('all-pages') }}</label>
                        ...
                        <div id="socialFieldGroup">
                            <div class="form-group">
                                ...
                                <p class="text-muted"> https://www.srpskiratnik.com</p>
                            </div>
                        </div>
                ...
                @else
                    <form method="post" action="{{ url('updatesettings') }}/{{$data->sid}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Logo</label>
                            @if(!empty($data->image))
                                <p><img src="{{ url('images_settings') }}/{{$data->image}}" id="output" ></p>
                                <p><input type="file"  accept="image/*" name="image" id="file"  onchange="loadFile(event)" style="display: none;"></p>
                        ...
                        <div id="socialFieldGroup">
                            <div class="form-group" id="socialCount">
                                <label>Social</label>
                                @foreach($data->social as $social)
                                    <div class="form-group">
                                        <input type="url" name="social[]" class="form-control" class="socialCount" value="{{ $social }}">
                                    </div>
                                @endforeach
                            </div>
                        </div>
