        ...
        <div class="container ">
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    <h2 class="module-title font-alt">Kontaktirajte nas</h2>
                                                ...
                                                <form method="post" action="{{ url('sendmessage') }}">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <h4 class="font-alt">UPIT</h4>
                                                            <textarea name="message" required placeholder="VAŠA PORUKA" class="form-control" rows="12" class="form-control"> </textarea>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <button class="btn btn-success" style="alignment: right">pošalji upit</button>
                                                    </div>
                                                </form>
                                        </div>
                                    </div>
