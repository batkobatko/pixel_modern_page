...
<html lang="en-US" dir="ltr">
    <head>
      ...
      <? // !! SEOMeta::generate() !!} ?>
        <meta property="og:url"                content="www.pixelprijedor/en" />
        <meta property="og:type"               content="article" />
        <meta property="og:title"              content="Order Your perfect design" />
        <meta property="og:description"        content="PIXEL is engaged in the development of clear, modern, but above all functional web applications. We follow world trends and try to bring them closer to the client. We are constantly learning new technologies to give our clients a web application that sets them apart from others. PIXEL is focused on the needs of our customers ..." />
    ...
    <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
        <main>
            ...
            <!--start header-->
            @include('layouts.front_layout.front_header_en')
            <!-- Header End====================================================================== -->
            <!--start banner-->
            @include('front.banners.home_page_banners_en')
        ...
        <!-- Footer ================================================================== -->
        @include('layouts.front_layout.front_footer_en')
